...
class TestEmbeddingPerformance:
    ...
    async def test_batch_embedding_performance(self, embedding_service):
        ...
        texts = [
            f"This is test sentence number {i} for batch performance evaluation."
            for i in range(50)
        ]
    ...
    async def test_embedding_cache_performance(self, embedding_service):
        ...
        assert second_time < first_time * 0.1, f"Cache hit time: {second_time:.3f}s vs first time: {first_time:.3f}s"
