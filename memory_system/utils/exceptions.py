...
def wrap_exception(exc_type: Type[_T], message: str, **context: Any) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    """
    ...
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            try:
                ...
                raise exc_type(message, context=context, cause=e)
        return wrapper
    return decorator
...
def log_exception(error: MemorySystemError, logger: Optional[logging.Logger] = None, level: int = logging.ERROR) -> None:
    """
